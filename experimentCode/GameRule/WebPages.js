var WebPages = {
  htmlByeUntrained: '<h2>'
  +
  ' Unfortunately, you failed to pass the status training.<br/> </h2>Thank you very much for your participation.<br/>' +
  'This experiment aims to examine how best to represent uncertainty in decision-making         ' +
  'tasks that are presented visually. <br> We are comparing two different ways of presenting ' +
  'this information <b>(you only saw one of them!)</b>.<br/> ' +
  'In the first way, the uncertain entities were hollow. <br/>' +
  'In the second way, the uncertain entities were filled and the more certain entites were hollow. <br/>' +
  'Further, some participants saw a lot of the uncertain entities, whereas others saw a more even mix.<br/>' +
  'We hope to see that it does not matter which type of entity is represented by a hollow ring.<br/>' +
