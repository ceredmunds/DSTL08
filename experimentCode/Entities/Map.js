var Map={
    ...
    setCurrentMap:function(name){
        ...
        //console.log("set current map  resolucion  %d %d " , Map.insideStroke.width, Map.insideStroke.height);
        //Init fog relative
  ...
  /*  drawMiniMap:function(){
    ...
    drawBg:function(){
        ...
        /*Game.backCxt.drawImage(Map.getCurrentMap(),Map.offsetX,Map.offsetY,Game.HBOUND,Game.VBOUND-50,
            0,0,Game.HBOUND,Game.VBOUND- 50);*/
        Game.backCxt.drawImage(Map.getCurrentMap(),Map.offsetX,Map.offsetY,Game.HBOUND,Game.VBOUND,
            0,0,Game.HBOUND,Game.VBOUND);


    },
    refresh:function(direction){
        var edgeX=Map.getCurrentMap().width-Game.HBOUND;
        var edgeY=Map.getCurrentMap().height-Game.VBOUND;
        var onlyMap;
        switch (direction){
            case "LEFT":
   ...
   //     if (!onlyMap) Map.drawFogAndMinimap();
    ...
    relocateAt:function(centerX,centerY){
        ...
        Map.offsetX=offsetX;
        Map.offsetY=offsetY;
        console.log(" offset x y   %f  %f", Map.offsetX , Map.offsetY)
