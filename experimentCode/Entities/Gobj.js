...
Gobj.prototype.insideScreen=function(){
  //  console.log(" x %f, y %f, widht %f heigh %f, offsett x %f, offset y%f " , this.x, this.y, this.width, this.height, Map.offsetX, Map.offsetY )
...
Gobj.prototype.cannotMove=function(){
    return  Boolean(this.burrowBuffer);
};
